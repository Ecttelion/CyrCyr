...
{
    public class PhotonGuided : EnnemyBullet
    {
        ...
        public PhotonGuided(CyrilusGamus game, Ship shooter) : base(game, shooter)
        {
            Gfx = "           :          \n          :=.         \n         .:.=         \n         :  -:        \n.:==:.::..   :::::==-.\n   .--.        .-=:   \n      :-      -=      \n      :.  ::   =      \n     .-:--..:-.:-     \n     ==:      .:=:    \n    ..           :    \n";
            ...
            Speed = game.Random.Next(50, 500);
            DmgMultiplayer = game.Random.Next(5, 10) / 10f;
        }
